...
public static class Shapes
{
    ...
    public static Geometry Rectangle => new RectangleGeometry { Rect = new Rect(0, 0, 20, 20) };

    public static Geometry Triangle => new PathGeometry(
    [
        new PathFigure(
            new Point(20, 20),
            new List<PathSegment> { new LineSegment(new Point(40, 0), true), new LineSegment(new Point(0, 0), true) }
                .AsReadOnly(),
            true)
    ]);
}
